...
**Regex Capture Configuration**

1. Click on "Change Me" and set the action to "Regex capture group".
2. For the input, select the `hashes` field from the Execution Argument section. The input should look like this:
```
